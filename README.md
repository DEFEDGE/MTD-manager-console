...
1. The [Framework description](Setups/Framework_description.md) file describes the first work done in the context of [DEFEDGE - PRIN PNRR 2022 Project](https://github.com/DEFEDGE) where a framework was built to perform MTD techniques on a ckubernetes cluster [1].
